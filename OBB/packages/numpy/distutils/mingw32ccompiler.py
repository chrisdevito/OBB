...
class Mingw32CCompiler(distutils.cygwinccompiler.CygwinCCompiler):
    ...
    def __init__ (self,
        ...
        if 'mingwpy' not in str(out_string):
        ...
        if get_build_architecture() == 'AMD64':
            if self.gcc_version < "4.0":
                ...
                self.set_executables(
                    compiler='gcc -march=x86-64 -mtune=generic -msse2 -DMS_WIN64 -O2 -Wall',
                    compiler_so='gcc -march=x86-64 -mtune=generic -msse2 -DMS_WIN64 -O2 -Wall -Wstrict-prototypes',
                    linker_exe='gcc',
            ...
            if self.gcc_version <= "3.0.0":
                ...
                self.set_executables(compiler='gcc -O2 -march=pentium4 -mtune=generic -mfpmath=sse -msse2 -mincoming-stack-boundary=2 -Wall',
                                     compiler_so='gcc -O2 -march=pentium4 -mtune=generic -mfpmath=sse -msse2 -mincoming-stack-boundary=2 -Wall -Wstrict-prototypes',
                                     linker_exe='g++ ',
